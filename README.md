...
## 목차
- [무엇을 해 주나요?](#무엇을-해-주나요) · [사전 준비물](#사전-준비물-무료-2가지) · [다운로드 방법](#다운로드-방법) · [내부 구조](#내부-구조-한눈에) · [빠른 설치](#빠른-설치-한-번만) · [명령어](#명령어) · [안전 동작 요약](#안전-동작-요약) · [문제가 생기면](#문제가-생기면) · [업데이트 내용](#업데이트-내용-요약) · [라이선스](#라이선스-저작권-상업적-사용-엄격) · [정직한 한계](#정직한-한계)

> 더 자세한 단계별 설명·아키텍처·FAQ는 **[GUIDE.md](./GUIDE.md)** 를 보세요(목차 포함).
